# Generated by Django 3.2.3 on 2022-12-03 23:18
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order_time', models.CharField(choices=[('11:00 AM', '11:00 AM'), ('01:00 PM', '01:00 PM'), ('03:00 PM', '03:00 PM')], max_length=20)),
                ('image', models.ImageField(blank=True, null=True, upload_to='receipts')),
                ('add_by', models.ForeignKey(blank=True, editable=False, null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
