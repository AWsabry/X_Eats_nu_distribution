...
urlpatterns = [
    ...
    path('get_user_cartItems/', view=views.get_user_cartItems, name='get_user_cartItems'),

    path('get_carts/', view=views.get_carts, name='get_carts'),
    path('get_carts_by_id/<int:id>', view=views.get_carts_by_id, name='get_carts_by_id'),
