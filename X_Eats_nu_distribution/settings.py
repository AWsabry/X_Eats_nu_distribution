"""
Django settings for X_Eats_nu_distribution project.
...
SECRET_KEY = 'django-insecure-cdgm3hemx-^m_0mru16%vyx_fji@nagse1e%a3*!v*-8ldczf4'
...
WSGI_APPLICATION = 'X_Eats_nu_distribution.wsgi.application'
